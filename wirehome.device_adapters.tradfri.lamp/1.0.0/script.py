SERVICE_ID = "wirehome.services.tradfri.gateway_manager"
...
def __initialize__():
    ...
    subscription_uid = wirehome.context["component_uid"] + "->tradfri.gateway_manager.event.device_state_changed"
